...
import { ArrowRight, ShieldAlert, Chrome } from "lucide-react";
      ...
      <div className="container relative z-10 mx-auto px-6 pt-24 pb-16">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg text-muted-foreground leading-relaxed">
            SentraShield detects passwords, API keys, PII, and confidential data the moment
          ...
          <div className="mt-20 grid grid-cols-3 gap-8 border-t border-border/50 pt-10">
            {[
              ...
              { value: "12K+", label: "Leaks prevented" },
            ].map((stat) => (
